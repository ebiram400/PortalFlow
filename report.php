...
<body>
    <!--------head-------->
    <div class="d-flex align-items-center justify-content-between color-nav">
    ...
    <div class="d-flex justify-content-center align-items-center mb-3">
        <div class="color-cyan fs-6 fw-bold me-2">گزارشات</div>
        <span class="material-symbols-outlined color-cyan fs-6">
            arrow_back_ios
        </span>
        <a href="./index.html" class="text-decoration-none">
            <div class="color-green fs-6 fw-bold me-2">صفحه اول</div>
        </a>
    ...
    <div class="head-reports">
        <div class="fs-7 fw-bold d-flex">
            <span class="material-symbols-outlined level1">
        ...
        <div class="project-name fs-4 fw-bold text-shadow-green">پروژه آقای مشهدی</div>
    </div>

    <embed src="./pdf/1.pdf" class="pdf">
    <embed src="./pdf/2.pdf" class="pdf">
